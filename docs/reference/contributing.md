...
[Read the EspControl developer guide on GitHub](https://github.com/jtenniswood/espcontrol/blob/main/DEVELOPERS.md)

That guide covers the project layout, local build tools, how the web configurator
is bundled, how to flash a development build, where logs come from, and what
needs to change when adding or fixing a card type.
...
- Run the checks listed in the developer guide before submitting code changes.
